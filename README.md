...
it allows our code to have meaning` 
2. Name two big differences between ```display: block;``` and ```display: inline;```.
block might spill into margins and padding
inline you can set a width and a height
...
it allows all the developers to have different versions of the same code they can work and test on that wont break eachothers then they can merge it once everything is tested and reviewed 
